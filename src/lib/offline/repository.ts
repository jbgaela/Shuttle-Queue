...
import { applyPlayerDeletion, historyDurationSeconds, isProhibitedGeneratedGenderMatch, normalizeText, skillWeight, suggestMatch, undefeatedChallengePlayers, validateBalancedLineup, validateScores } from "./domain-compat";
