...
export type HistoryMatch = { id: string; source: string; matchmakingMode?: string | null; matchmakingLabel?: string; format: "SINGLES" | "DOUBLES"; court: { id: string; name: string } | null; startedAt?: string | null; completedAt?: string | null; durationSeconds: number | null; winnerTeam: "A" | "B" | null; version: number; scoring: { pointsToWin: number; winBy: number; scoreCap: number | null; bestOf: 1 | 3 }; score: { revisionNumber: number; winnerTeam: "A" | "B"; games: HistoryGame[] } | null; participants: HistoryParticipant[] };
