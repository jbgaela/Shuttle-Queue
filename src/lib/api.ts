...
export type FeePlayer = { sessionPlayerId: string; displayName: string; dueMinor: number; collectedMinor: number; waivedMinor: number; outstandingMinor: number; status: "WAIVED" | "PAID" | "PARTIAL" | "UNPAID" };
