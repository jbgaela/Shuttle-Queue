...
export const api = {
  ...
  updateSettings: (body: { defaultLateArrivalCutoffTime?: string | null; minimumRestMinutes?: number }, version?: number) => request<AccountSettings>("/settings", { method: "PATCH", ...(version === undefined ? {} : { headers: { "if-match": String(version) } }), body: JSON.stringify(body) }),
