...
import { currentDateTimeForTimezone, dateTimeInputForTimezone, inclusiveMinuteInstantForLocalDateTime, instantForLocalDateTime } from "../../src/lib/timezone.ts";
...
test("account-local datetime fields use the account timezone", () => {
  ...
  assert.equal(inclusiveMinuteInstantForLocalDateTime("2026-08-15T01:05", "Asia/Manila"), "2026-08-14T17:05:59.999Z");
});
